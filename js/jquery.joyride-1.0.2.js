...
(function($) {
  $.fn.joyride = function(options) {
    ...
    return this.each(function() {
      ...
      tipTemplate = function(tipClass, index, buttonText, self) { return '<div class="joyride-tip-guide ' + tipClass + '" id="joyRidePopup' + index + '"><span class="joyride-nub"></span>' + $(self).html() + buttonText + '<a href="#close" class="joyride-close-tip">&times;</a>' + timerIndicatorInstance + '</div>'; },
