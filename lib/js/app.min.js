...
"class":"icon-chevron-left"}).css({top:"19px",right:"15px"})})):($("#panel-wrapper, #map-canvas").animate({left:"-380px"},100,"linear",function(){a.Views.CampusMap.resizeMap()}),$("#options-nav-bar").animate({left:"22px",height:"10px",padding:"5px"},100,"linear",function(){$("#map-options-toggler").attr({title:"Open this sidebar","class":"icon-chevron-right"}).css({top:"1px",right:"-2px"})}));return!1}})});